...
import twitterhome from "../../../assets/images/giveaway-image.png";
          ...
          <div className="flex lg:flex-row flex-col xl:gap-4 lg:gap-14 gap-4">
            ...
            <div className="lg:w-1/2 w-full lg:mt-12 -mt-16">
              ...
              <p className="font-robotoFlex text-sm text-blackLight pt-10 pb-6">
                Unlock the excitement as every single like and retweet gets it’s
                chance to shine and claim victory. Try it today and witness the
                magic unfold as engagement turns into coveted wins!
              </p>
